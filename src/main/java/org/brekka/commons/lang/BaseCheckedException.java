 ...
 */
public abstract class BaseCheckedException extends Exception implements ErrorCoded {
    /**
     * Serial UID
     */
    private static final long serialVersionUID = -9203881192312992793L;
    ...
    /**
     * Construct a new Checked Exception. The code will deal robustly if no arguments are specifed but at a minimum the
     ...
     */
    public BaseCheckedException(final ErrorCode errorCode, final String message, final Object... messageArgs) {
     ...
     * @param messageArgs objects that should be bound to placeholders in the message string.
     */
    public BaseCheckedException(final String message, final Object... messageArgs) {
     ...
     * @param messageArgs objects that should be bound to placeholders in the message string.
     */
    public BaseCheckedException(final Throwable cause, final String message,
     ...
     * @param messageArgs objects that should be bound to placeholders in the message string.
     */
    public BaseCheckedException(final ErrorCode errorCode, final Throwable cause, final String message,
            final Object... messageArgs) {
        super(message);
        if (errorCode != null) {
